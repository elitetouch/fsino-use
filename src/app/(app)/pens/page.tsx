...
function PenCard({ pen }: { pen: PenDto }) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-[var(--color-brand-border)] bg-white p-5 transition-all hover:border-[var(--color-brand-primary)]/40 hover:shadow-[0_20px_50px_-25px_rgba(15,80,30,0.20)]">
